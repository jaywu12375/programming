...
var numOfpoints = 7 //how many points we want
...
function draw() {
  background(50,50,50); //an RGB color for the canvas' background (dark blue)
  //moon
  fill(135,206,250,200); //white, 200 level of transparency (min = 0, max = 255)
  noStroke();
  ...
  textAlign(RIGHT);
  textFont("Palatino");
  fill(255,255,51,t); // yellow, t refers to the transparency (set to fully opaque (255) at the beginning (see variable a the top of the sketch))
  text("hello",width-20, height-20);
  ...
  //firefly
  fill(255,200); //white, semi-transparent
  ellipse(mouseX,mouseY,25,25); // follows the mouse, 10px dia
  //firefly2
  fill(255,200); //white, semi-transparent
  ellipse(mouseX,mouseY,50,50); // follows the mouse, 10px dia
